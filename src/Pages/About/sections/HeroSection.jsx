...
const HeroSection = () => {
    return (
        <div className='w-full bg-secondaryDark text-headingDark pb-20  px-4 sm:px-12 xl:px-64  2xl:px-80  pt-40 flex flex-col justify-center items-center relative sm:min-h-screen'>
            ...
            <button className=' my-6 px-8 py-2 text-headingDark font-bold cursor-pointer transition-all duration-300 border-2 border-textDark bg-buttonPrimary text-center rounded-md hover:-translate-y-2'>Meet The Artist</button>
