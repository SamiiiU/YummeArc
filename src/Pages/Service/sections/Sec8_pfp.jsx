...
const Sec8_pfp = () => {
    return (
        <div className='w-full  z-30 grid lg:grid-cols-2 grid-cols-1 gap-10  md:min-h-screen  text-textDark bg-primaryDark relative md:py-20'>
            <AOSInitializer />
            ...
            <div data-aos="fade-top" className='col-span-1 h-full min-h-[26rem]  order-2 lg:order-1' style={{ backgroundImage: `url("https://res.cloudinary.com/dqflexfdy/image/upload/v1754813039/sec8_pfp_tzhzpn.png")`, backgroundSize: 'contain', backgroundPosition: 'center', backgroundRepeat: 'no-repeat' }} />
