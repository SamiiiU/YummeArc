...
const Chibbi = () => {
    ...
    return (
        <div className='w-full  z-30 grid lg:grid-cols-2 grid-cols-1 gap-10  text-textDark bg-primaryDark relative py-10'>
            <AOSInitializer />
            ...
            <div data-aos="fade-top" className='w-[450px] md:w-[500px] mx-auto 3xl:h-[26rem] h-[30rem]  order-2 lg:order-1 
