...
const OurProcess = () => {
    ...
    return (
        ...
        bg-gradient-to-b from-white to-purpleTo  py-20'>
            ...
            <h1 className='w-full text-center  font-[600]  lg:text-[3.5rem] text-5xl leading-[1.1] text-textColor  '>From Vision to Virtual Star</h1>
            <p className='w-full text-center my-6 lg:text-xl text-lg '>We take care of every step—from concept to final render—with care, precision, and passion.</p>
