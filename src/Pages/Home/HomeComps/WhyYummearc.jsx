...
const WhyYummearc = () => {
  ...
  return (
    <div className='w-full  bg-white flex flex-col justify-center  pb-20  min-h-screen relative space-y-20'>
            <AOSInitializer   />


      <div className='w-full 2xl:px-80 z-30 flex justify-center items-center flex-col lg:flex-row gap-10 sm:rounded-3xl bg-gradient-to-b from-purpleFrom to-purpleTo relative pt-10'>
        {/* Home text  */}
        <div className='lg:w-1/2 w-full lg:items-start justify-center md:items-center  flex flex-col  gap-y-4 sm:p-16 p-4 min-h-[24rem]'>
        ...
        <span data-aos="fade-left" className='lg:w-1/2 w-full h-full min-h-[26rem] mask-y-from-70% mask-y-to-90% ' style={{ backgroundImage: `url("${whyYmmearc}")`, backgroundSize: 'contain', backgroundPosition: 'center', backgroundRepeat: 'no-repeat' }}/>


      </div>

      
      <div className='w-full grid sm:grid-cols-2 grid-cols-1 xl:gap-16 lg:gap-8 gap-6 my-10 px-4 sm:px-12 2xl:px-80'>
