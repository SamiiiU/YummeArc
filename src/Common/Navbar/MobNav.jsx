...
const MobNav = () => {
  ...
  return (
    <div className='w-full p-4  z-50  fixed text-headingDark'>
      ...
      <div className='w-full h-screen fixed top-0 left-0 p-4 pt-20 bg-primaryDark-950/90 backdrop-blur-sm z-40  transition-all duration-200'
